            ...
            <div class="modal-body">
                <div class="card-body">
                    ...
                    <div class="row" id="proof_image">
                        {{-- <div class="col-md-4 ">
                            <a href="/assets/theam-default/assets/images/error-img.png" data-fancybox="proof_document">
                                <img src="assets/theam-default/assets/images/error-img.png" alt="" class="img-fluid" height="300">
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="/assets/theam-default/assets/images/error-img.png" data-fancybox="proof_document">
