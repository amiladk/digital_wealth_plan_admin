                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                             @foreach(getAllPermissions() as $group)
                                @if($group['type']=='single')
                                    @if(isPermissions($group['data'][0]['permission']))<li><a href="{{route($group['data'][0]['permission'])}}"><i class="{{$group['icon']}}"></i> <span data-key="t-dashboard">{{$group['group']}}</span></a></li>@endif
                                @else
                                    <?php $links = '';
                                    ...
                                    @if($links != '')
                                        <li>
                                            <a href="javascript: void(0);" class="has-arrow">
                                                ...
                                                <span data-key="t-pages">{{$group['group']}}</span>
                                            </a>
