    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                <form method='post' action="<?php echo e(url('/action/crypto-network-create')); ?>" id="crypto-network-create-form">
                <?php echo csrf_field(); ?>
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $crypto_networks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($data->title); ?></td>
                                <td><?php echo e($data->network_fee); ?></td>
                                <td><?php echo e($data->withdrawal_fee); ?></td>
                                <td><?php echo e($data->is_active ? 'Active' : 'Inactive'); ?></td>
                                <td><?php echo e($data->client_wallet ? 'Yes' : 'No'); ?></td>
                                <td><?php echo e($data->company_wallet_address); ?></td>
                                <td><a type="button" data-bs-toggle="modal" data-bs-target="#edit-crypto-network" onclick="editCryptoNetworkModal(<?php echo e($key); ?>)" class="btn btn-dark waves-effect waves-light btn-sm"><i class="fas fa-edit"></i></a></td>
                            </tr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method='post' action="<?php echo e(url('/action/crypto-network-edit')); ?>" id="crypto-network-edit-form">
                <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\Pradeep\bitbucket\lemaconet_admin\resources\views/crypto-network.blade.php ENDPATH**/ ?>